#Diccionarios_ejemplo4

# Confeccionar un programa que permita cargar un código de producto como
# clave en un diccionario. Guarda para dicha clave el nombre del producto,
# su precio y cantidad en stock
# Implementar las siguientes actividade:
# 1) Carga de datos en el diccionario
# 2) Listado completo de productos.
# 3) Cosulta de un producto por su clave, mostrar el nombre, precio y stock
